...
const (
	...
	ERROR_UPLOAD_CHECK_IMAGE_FORMAT = 300031

	ERROR_TOKEN_EXPIRE   = 30003 //token失效
	ERROR_SERVER_ERROR   = 10000 //服务器错误
	ERROR_INVALID_PARAMS = 20000 //参数错误

	ERROR_DATA_ERROR = 20011 //数据不存在
)
