...
func TestSprite(t *testing.T) {
	//读取json文件
	//spriteByte, err := ioutil.ReadFile("/Users/quon/go/src/github.com/Quons/go-gin-example/demo/sprites.json")
	spriteByte, err := ioutil.ReadFile("/Users/quon/go/src/github.com/Quons/go-gin-example/demo/sounds.json")
	if err != nil {
		fmt.Println(err)
		return
	}
...
func DownloadFile(md5 string, t *testing.T) error {
	...
	//err = ioutil.WriteFile("/Users/quon/go/src/github.com/Quons/go-gin-example/demo/asset/"+md5, body, 766)
	err = ioutil.WriteFile("/Users/quon/go/src/github.com/Quons/go-gin-example/demo/sounds/"+md5, body, 766)
	if err != nil {
		return err
	}
	return nil
